...
export default function Home() {
  ...
  return (
    <div style={{ width: "100vw", height: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
      <div style={{ width: "30vw", display: "flex", flexDirection: "column", gap: "1.5vw" }}>
        <div style={{ textAlign: "center" }}>
          <span style={{ fontSize: "1.4vw", fontWeight: 600, color: "#fff" }}>
            New Recording
          </span>
        </div>
        ...
        <div style={{ background: "#0f0f0f", borderRadius: "0.1vw", border: "0.05vw solid #1a1a1a", padding: "0.8vw 1vw" }}>
